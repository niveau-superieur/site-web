...
export const swimmingActivities: Activity[] = [
  ...
  {
    name: `Triathlon - Natation - 3x300+3x100+6x50`,
    date: '2026-08-28',
    duration: 53,
    distance: 2.5,
    tags: [activityTags.sport, activityTags.swimming],
